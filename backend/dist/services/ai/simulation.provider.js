export class SimulationProvider {
    ...
    simulateArchitectureResponse(input) {
    ...
    simulatePlanningResponse(input) {
        return JSON.stringify({
            phases: [
                {
                    id: "p1",
    ...
    simulateDecompositionResponse(system, user) {
    ...
    simulateCodingResponse(system, user) {
    ...
    simulateIntegrationResponse(input) {
        return JSON.stringify({
            changes: [],
